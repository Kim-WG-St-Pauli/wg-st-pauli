  ...
  const seasons = [
    {
      ...
      episodes: [
        ...
        },
        {
          ...
          summary: "25 Jahre Leben, in ein winziges Zimmer gequetscht – wie kann das funktionieren?",
          video: { id: "1169522888", h: "abc7171239" },
          talk: { id: "1169523200", h: "986bd7a503" },
        },
        {
          id: "s1f2", no: "2", title: "Knapp bei Kasse", date: "2026-04-25",
          logline: "Das Konto sagt Nein. Die WG sagt trotzdem Ja.",
          summary: "Silkes Einzug in die WG beginnt mit aufschlussreichen Geständnissen!",
          video: { id: "1169523004", h: "07a167ba8c" },
          talk: { id: "1169523413", h: "8d93781611" },
        },
        {
          id: "s1f3", no: "3", title: "Herr Schulz", date: "2026-05-02",
          logline: "Wer ist Herr Schulz?",
          summary: "Beate öffnet ihr geheimnisvolles Zimmer, in dem sie auch ihrem Nebenjob nachgeht…",
          video: { id: "1169536629", h: "8b86bde9a6" },
          talk: { id: "1169538393", h: "5cc32cb9bf" },
        },
        {
          id: "s1f4", no: "4", title: "WG-Party & Kritikstunde", date: "2026-05-09",
          logline: "Silkes Einzug wird gefeiert – erst wird gefeiert, dann Autorin Kim kritisiert",
          summary: "Silkes Einzug in die WG muss natürlich gebührend gefeiert werden!",
        ...
        },
        {
          ...
          summary: "Was bleibt nach der ersten Staffel? Autorin Kim Perator zieht Bilanz. Gemeinsam mit den Bewohnern. Wie wird es weiter gehen?",
      ...
      episodes: [
        {
        ...
        },
         {
          ...
          summary: "Weltenbummlerin Silke überrascht die WG mit „gesundem Essen“… – Folge zwei von Staffel zwei.",
